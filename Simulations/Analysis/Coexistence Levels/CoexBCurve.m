...
figure()
hold on; box on;
plot(B,Epts(:,1),'Linewidth',2)
plot(B,Epts(:,2),'Linewidth',2)
xlabel('q')
ylabel('Scaled populations at equilibrium')
legend('C','F')
title('Equilbrium values as function of half-saturation value (b)')
...
col = [B(1:end-1), NaN]; % Must end in NaN to filling a solid
