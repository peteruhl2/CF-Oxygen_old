...
title('Path of equilibrium point for 3e-5 < q < 2')

%%% equilib population values as function of q
figure()
hold on; box on;
plot(Q,Epts(:,1),'Linewidth',2)
plot(Q,Epts(:,2),'Linewidth',2)
xlabel('q')
ylabel('Scaled populations at equilibrium')
legend('C','F')
title('Equilbrium values as function of oxygen toxicity (q)')
...
col = [Q(1:end-1), NaN]; % Must end in NaN to filling a solid
