%%% surf of eta and lambda vs exacerbation time
%%% 5/11/2020
...
res = 50;
Eta = linspace(1.883e-4, 7.883e-4, res);
LambdaFrac = linspace(0.7,1.2,res);
results = zeros(length(Eta),length(LambdaFrac));
